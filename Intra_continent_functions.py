...
# Return:   None ( VOID )                                                                                              #
#----------------------------------------------------------------------------------------------------------------------#
def run_intra_continent_analysis(df_continent):
    continent_name = df_continent.Continent.iloc[0]
    ...
    single_continent_plots(df_continent, continent_name, log_file)
    log_file.close()
#----------------------------------End of Function run_intra_country_analysis------------------------------------------#

# ---------------------------------------------------------------------------------------------------------------------#
# Function: single_continent_plots                                                                                     #
#                                                                                                                      #
# Goal:     Create various informative plots for the selected continent                                                #
#                                                                                                                      #
# Input:    1. df_continent - A subset of the original dataset, containing all data for the selected continent         #
#                                                                                                                      #
# Return:   None ( VOID )                                                                                              #
#----------------------------------------------------------------------------------------------------------------------#
def single_continent_plots(df_continent,continent_name, log_file):

    # Add a column as complementary of the employment sectors to 100%
    df_continent['employment_other'] = 100 - (df_continent['employment_industry'] +
                                              df_continent['employment_services'] +
                                              df_continent['employment_agriculture'] )

    log_file.write(f'\n\nStarting single_continent_plots function\n')
    log_file.write(f'#----------------------------#\n')
    ...
    with col1:
        ...
        sns.histplot(data=df_continent, x='gdp', bins=10, ax=ax_gdp, color='green', kde = True)
        ax_gdp.set_title(f'Distribution of GDP for {continent_name}')
    ...
    with col2:
        ...
        sns.boxplot(data=df_continent, x='Continent', y='gdp', ax=ax_gdp_bp, color='green')
        ax_gdp_bp.set_title(f'GDP for continent {continent_name}, a boxplot representation')
    ...
    with col3:
        ...
        sns.histplot(data=df_continent, x='gdp_per_capita', bins=10, ax=ax_gdp_per_capita, color='royalblue', kde = True)
        ax_gdp_per_capita.set_title(f'Distribution of GDP Per Capita for {continent_name}')
    ...
    with col4:
        ...
        sns.boxplot(data=df_continent, x='Continent', y='gdp_per_capita', ax=ax_gdp_per_capita_bp, color='royalblue')
        ax_gdp_per_capita_bp.set_title(f'GDP Per Capita for continent {continent_name}, a boxplot representation')
    ...
    df_continent_sorted_gdp = df_continent.sort_values('gdp', ascending = False)
    sns.barplot(x=df_continent_sorted_gdp.index, y='gdp', data=df_continent_sorted_gdp, color='green', ax=ax1, label='GDP')
    ax1.set_xlabel('Country')
    ax1.set_ylabel('GDP [Millions of $]', color='green')
    ax1.tick_params(axis='y', labelcolor='green')
    ax1.set_xticks(range(len(df_continent_sorted_gdp.index)))  # Explicitly set tick locations
    ax1.set_xticklabels(df_continent_sorted_gdp.index, rotation=90, ha='right')

    # Create a second y-axis that shares the same x-axis
    ax2 = ax1.twinx()

    # Plot GDP per Capita on the second y-axis
    sns.lineplot(x=df_continent_sorted_gdp.index, y='gdp_per_capita', data=df_continent_sorted_gdp, color='royalblue', marker='o', ax=ax2,
                 label='GDP per Capita')
    ax2.set_ylabel('GDP per Capita [$]', color='royalblue')
    ax2.tick_params(axis='y', labelcolor='royalblue')

    # Add title and combined legends
    plt.pyplot.title(f'GDP vs. GDP per Capita for countries in {continent_name} ')
    ...
    with col5:
        ...
        sns.histplot(data=df_continent, x='gdp_growth', bins=10, ax=ax_gdp_growth, color='lightgreen', kde = True)
        ax_gdp_growth.set_title(f'Distribution of GDP Growth for {continent_name}')
    ...
    with col6:
        ...
        sns.histplot(data=df_continent, x='pop_growth', bins=10, ax=ax_pop_growth, color='lightgrey', kde = True)
        ax_pop_growth.set_title(f'Distribution of Population Growth for {continent_name}')
    ...
    df_growth_unified = df_continent[['gdp_growth', 'pop_growth']].melt(var_name='Growth_Type',
    ...
    ax_growth_bp.set_title(f'GDP Growth and Population Growth for countries in {continent_name}')
    ...
    with col7:
        ...
        sns.histplot(data=df_continent, x='fertility', bins=5, ax=ax_fertility_rate, color='gold', kde = True)
        ax_fertility_rate.set_title(f'Distribution of fertility rate for {continent_name}')
    ...
    with col8:
        ...
        sns.boxplot(data=df_continent, x='Continent', y='fertility', ax=ax_fertility_rate_bp, color='gold')
        ax_fertility_rate_bp.set_title(f'Fertility for countries in {continent_name}, a boxplot representation')
    ...
    # Violin plot for school enrollment by gender
        ...
        df_school_enrollment_violin = df_continent[enrollment_cols].copy()
    ...
    # Create the violin plot
        ...
        ax_enrollment.set_title(f'School Enrollment Distribution by Gender for countries in {continent_name}')
    ...
    with col18:
        ...
        ax_life_expectancy.set_title(f'Life Expectancy Distribution by Gender for countries in {continent_name}')
    ...
    with col19:
        ...
        sns.histplot(data=df_continent, x='infant_mortality', bins=10, ax=ax_infant_mortality, color='red', kde = True)
        ax_infant_mortality.set_title(f'Distribution of infant mortality for countries in {continent_name}')
    ...
    with col20:
        ...
        sns.boxplot(data=df_continent, x='Continent', y='infant_mortality', ax=ax_infant_mortality_bp, color='red')
        ax_infant_mortality_bp.set_title(f'Distribution of infant mortality for countries in {continent_name}, a boxplot representation')
    ...
    with col21:
        ...
        sns.histplot(data=df_continent, x='co2_emissions', bins=10, ax=ax_co2_emissions, color='cyan', kde = True)
        ax_co2_emissions.set_title(f'Distribution of co2 emissions for countries in {continent_name}')
    ...
    with col22:
        ...
        sns.boxplot(data=df_continent, x='Continent', y='co2_emissions', ax=ax_co2_emissions_bp, color='cyan')
        ax_co2_emissions_bp.set_title(f'Distribution of co2 emissions for countries in {continent_name}, a boxplot representation')
    ...
    with col23:
        ...
        sns.histplot(data=df_continent, x='tourists', bins=10, ax=ax_tourists, color='salmon', kde = True)
        ax_tourists.set_title(f'Distribution data on number tourists for countries in {continent_name}')
    ...
    with col24:
        ...
        sns.boxplot(data=df_continent, x='Continent', y='tourists', ax=ax_tourists_bp, color='salmon')
        ax_tourists_bp.set_title(f'Distribution data on number tourists for countries in {continent_name}, a boxplot representation')
    ...
    with col25:
        ...
        sns.histplot(data=df_continent, x='homicide_rate', bins=10, ax=ax_homicide_rate, color='red', kde = True)
        ax_homicide_rate.set_title(f'Distribution of homicide rate for countries in {continent_name}')
    ...
    with col26:
        ...
        sns.boxplot(data=df_continent, x='Continent', y='homicide_rate', ax=ax_homicide_rate_bp, color='red')
        ax_homicide_rate_bp.set_title(f'Distribution of homicide rate for countries in {continent_name}, a boxplot representation')
    ...
    df_refugees_extended = df_continent
    ...
    with col27:
        ...
        ax_refugees_portion.set_title(f'Distribution of refugees portion from total population for countries in {continent_name}')
    ...
    with col28:
        ...
        sns.boxplot(data=df_refugees_extended, x='Continent', y='refugees_portion', ax=ax_refugees_portion_bp, color='purple')
        ax_refugees_portion_bp.set_title(f'Distribution of refugees portion from total population for countries in {continent_name}, a boxplot representation')
    ...
    log_file.write(f'\nsingle_continent_plots function concluded\n')
    log_file.write(f'#-----------------------------------------------------------------------#\n')
