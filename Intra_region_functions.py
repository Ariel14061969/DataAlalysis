...
#                                                                                                                      #
# Goal:     A wrapper function that launches all inta region analysis functions one by one                          #                                                                                      #
#                                                                                                                      #
...
def single_region_plots(df_region,region_name, log_file):
    ...
    with col10:
        ...
        df_employment_violin = df_region[employment_cols_for_violin].melt(
        ...
        ax_employment_violin.set_title(f'Distribution of Employment Categories in {region_name}')
    ...
    with col15:
        df_school_enrollment_unified_box = df_region[['primary_school_enrollment_female', 'primary_school_enrollment_male',
        ...
        ax_school_enrollment_bp.set_title(f'School enrollment distribution by gender for countries in {region_name}')
    ...
    with col17:
        df_life_expectancy_unified_box = df_region[
        ...
        ax_life_expectancy_bp.set_title(f'Life expectancy distribution by gender for countries in {region_name}')
